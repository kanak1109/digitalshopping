...
const Hero = () => {
  ...
  <section className='relative bg-hero bg-center bg-no-repeat h-screen w-full'>
    <div className='max_padd_container relative top-32 xs:top-52'>
        ...
        <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis itaque quod, expedita dignissimos nisi distinctio quam tempore veritatis fuga quisquam dicta amet accusantium dolore perspiciatis, cumque exercitationem asperiores cum. Optio?</p>
